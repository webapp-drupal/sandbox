 ...
 */
interface CakeEntityInterface extends  ContentEntityInterface, EntityChangedInterface, EntityOwnerInterface {
   ...
   *   The Cake name.
   *
   * @return \Drupal\fatbeehive_cakes\Entity\CakeEntityInterface
