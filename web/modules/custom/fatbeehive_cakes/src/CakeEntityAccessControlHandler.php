 ...
 *
 * @see \Drupal\fatbeehive_cakes\Entity\CakeEntity.
 */
class CakeEntityAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\fatbeehive_cakes\Entity\CakeEntityInterface $entity */
    switch ($operation) {
      case 'view':
